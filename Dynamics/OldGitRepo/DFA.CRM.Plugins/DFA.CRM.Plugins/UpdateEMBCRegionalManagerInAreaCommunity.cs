...
namespace DFA.CRM.Plugins
{
    ...
    /// </summary>
    public class UpdateEMBCRegionalManagerInAreaCommunity : IPlugin
    {
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            try
            {
                    ...
                    (context.MessageName == "Update"))
                {
                    ...
                    string kidEntity = "dfa_areacommunities";
                    ...
                    {
                        //Update EMBC Regional Manager in Area/Community Entity
                        Entity areaCommunityRecord = new Entity("dfa_areacommunities");
                        areaCommunityRecord.Id = relatedKidEntityRecord.Id;
                        areaCommunityRecord["dfa_embcregionalmanager"] = eMBCRegionalManager;
                        Tracing.Trace($"{CustomCodeHelper.LineNumber()}: Updating Trace Record");
                        service.Update(areaCommunityRecord);
                    }
                }
                else
                {
