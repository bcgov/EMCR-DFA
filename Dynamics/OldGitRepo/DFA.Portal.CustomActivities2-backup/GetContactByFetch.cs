...
namespace DFA.CRM.CustomWorkflow2
{
    ...
    /// </summary>
    public class GetContactByFetch : CodeActivity
    {
        ...
        public OutArgument<EntityReference> ContactFound { get; set; }
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                {
                    EntityReference erreference = new EntityReference("contact", recordsToProcess.Entities[0].Id);
                    this.ContactFound.Set(activityContext, erreference);
                }
            }
            catch
            {
