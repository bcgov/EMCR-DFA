...
namespace DFA.CRM.CustomWorkflow2
{
    ...
    /// </summary>
    public class GetAppContactByFetch : CodeActivity
    {
        ...
        [Output("App Contact")]
        [ReferenceTarget("dfa_appcontact")]
        public OutArgument<EntityReference> AppContact { get; set; }
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                {
                    EntityReference erreference = new EntityReference("dfa_appcontact", recordsToProcess.Entities[0].Id);
                    this.AppContact.Set(activityContext, erreference);
                }
            }
            catch
            {
