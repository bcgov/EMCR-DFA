...
namespace DFA.CRM.CustomWorkflow
{
    ...
    /// </summary>
    public class GetAppDocumentLocationByFetch : CodeActivity
    {
        ...
        [Output("App Document Location")]
        [ReferenceTarget("dfa_appdocumentlocations")]
        public OutArgument<EntityReference> AppDocumentLocation { get; set; }
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                {
                    EntityReference erDoclocation = new EntityReference("dfa_appdocumentlocations", recordsToProcess.Entities[0].Id);
                    this.AppDocumentLocation.Set(activityContext, erDoclocation);
                }
            }
            catch
            {
