...
namespace DFA.CRM.CustomWorkflow
{
    ...
    /// </summary>
    public class GetSpDocumentLocationByFetch : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                {
                    EntityReference erDoclocation = new EntityReference("sharepointdocumentlocation", recordsToProcess.Entities[0].Id);
                    this.DocumentLocation.Set(activityContext, erDoclocation);
                }
            }
            catch
            {
