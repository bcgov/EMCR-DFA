...
namespace DFA.CRM.CustomWorkflow2
{
    ...
    /// </summary>
    public class GetEventByFetch : CodeActivity
    {
        ...
        public OutArgument<EntityReference> EventFound { get; set; }
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                {
                    EntityReference erreference = new EntityReference("dfa_event", recordsToProcess.Entities[0].Id);
                    this.EventFound.Set(activityContext, erreference);
                }
            }
            catch
            {
