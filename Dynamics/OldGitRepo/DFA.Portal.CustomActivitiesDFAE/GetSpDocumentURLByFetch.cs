...
namespace DFA.CRM.CustomWorkflow2
{
    ...
    /// </summary>
    public class GetSpDocumentURLByFetch : CodeActivity
    {
        ...
        [Output("Doc URL")]
        public OutArgument<string> DocURL { get; set; }

        [Output("relativelocation")]
        public OutArgument<string> relativelocation { get; set; }
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                {
                    this.DocURL.Set(activityContext, recordsToProcess.Entities[0]["absoluteurl"].ToString());
                    this.relativelocation.Set(activityContext, recordsToProcess.Entities[0]["relativelocation"].ToString());
