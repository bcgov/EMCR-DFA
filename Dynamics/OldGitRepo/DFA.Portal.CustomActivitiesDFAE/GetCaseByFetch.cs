...
namespace DFA.CRM.CustomWorkflow2
{
    ...
    /// </summary>
    public class GetCaseByFetch : CodeActivity
    {
        ...
        public OutArgument<EntityReference> CaseFound { get; set; }
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                {
                    EntityReference erreference = new EntityReference("incident", recordsToProcess.Entities[0].Id);
                    this.CaseFound.Set(activityContext, erreference);
                }
            }
            catch
            {
