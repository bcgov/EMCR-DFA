...
namespace DFA.CRM.CustomWorkflow2
{
    ...
    /// </summary>
    public class GetAppApplicationByFetch : CodeActivity
    {
        ...
        public OutArgument<EntityReference> AppApplication { get; set; }
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                {
                    EntityReference erreference = new EntityReference("dfa_appapplication", recordsToProcess.Entities[0].Id);
                    this.AppApplication.Set(activityContext, erreference);
                }
            }
            catch
            {
