...
namespace DFA.CRM.CustomWorkflow2
{
    ...
    /// </summary>
    public class GetAreaByFetch : CodeActivity
    {
        ...
        [Output("AreaFound")]
        [ReferenceTarget("dfa_areacommunities")]
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                {
                    EntityReference erreference = new EntityReference("dfa_areacommunities", recordsToProcess.Entities[0].Id);
