...
namespace DFA.CRM.CustomWorkflow2
{
    ...
    /// </summary>
    public class GetBuildingOwnerByFetch : CodeActivity
    {
        ...
        [Output("BuildingOwnerFound")]
        [ReferenceTarget("dfa_buildingownerlandlord")]
        public OutArgument<EntityReference> BuildingOwnerFound { get; set; }
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                {
                    EntityReference erreference = new EntityReference("dfa_buildingownerlandlord", recordsToProcess.Entities[0].Id);
                    this.BuildingOwnerFound.Set(activityContext, erreference);
                }
            }
            catch
            {
