...
namespace DFA.CRM.CustomWorkflow2
{
    ...
    public class GetAccountByFetch : CodeActivity
    {
        ...
        public OutArgument<EntityReference> AccountFound { get; set; }
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                {
                    EntityReference erreference = new EntityReference("account", recordsToProcess.Entities[0].Id);
                    this.AccountFound.Set(activityContext, erreference);
                }
            }
            catch
            {
