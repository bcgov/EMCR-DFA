...
{
    public class HasLookupAttributeChangedActivity : CodeActivity
    {
        [RequiredArgument]
        [Input("Lookup Field Schema Name")]
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                OldValue = TargetPreImage?.GetAttributeValue<EntityReference>(schemaName);
                NewValue = Target.GetAttributeValue<EntityReference>(schemaName);
                ...
                var valuesAreEqual = (OldValue != null && NewValue != null && OldValue.Id == NewValue.Id);
