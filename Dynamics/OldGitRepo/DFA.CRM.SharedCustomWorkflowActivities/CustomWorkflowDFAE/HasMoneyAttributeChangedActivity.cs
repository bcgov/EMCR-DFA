...
{
    public class HasMoneyAttributeChangedActivity : CodeActivity
    {
        [RequiredArgument]
        [Input("Money Field Schema Name")]
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                OldValue = TargetPreImage?.GetAttributeValue<Money>(schemaName);
                NewValue = Target.GetAttributeValue<Money>(schemaName);
