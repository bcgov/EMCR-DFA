...
{ 
    public class HasOptionSetAttributeChangedActivity : CodeActivity
    {
        [RequiredArgument]
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                OldValue = TargetPreImage?.GetAttributeValue<OptionSetValue>(schemaName);
                NewValue = Target.GetAttributeValue<OptionSetValue>(schemaName);
