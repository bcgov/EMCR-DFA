...
{
    public class HasBooleanAttributeChangedActivity : CodeActivity
    {
        [RequiredArgument]
        [Input("Boolean Field Schema Name")]
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                OldValue = TargetPreImage?.GetAttributeValue<Nullable<bool>>(schemaName);
                NewValue = Target.GetAttributeValue<Nullable<bool>>(schemaName);
