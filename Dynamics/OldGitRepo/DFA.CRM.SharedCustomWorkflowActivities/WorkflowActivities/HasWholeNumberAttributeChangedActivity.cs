...
{
    public class HasWholeNumberAttributeChangedActivity : CodeActivity
    {
        [RequiredArgument]
        [Input("Whole Number Field Schema Name")]
        ...
        protected override void Execute(CodeActivityContext activityContext)
        {
            try
            {
                ...
                OldValue = TargetPreImage?.GetAttributeValue<Nullable<int>>(schemaName);
                NewValue = Target.GetAttributeValue<Nullable<int>>(schemaName);
